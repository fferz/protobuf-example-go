...
const (
	DayOfWeek_UNKWNOWN  DayOfWeek = 0
...
type EnumsMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id        int32     `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	DayOfWeek DayOfWeek `protobuf:"varint,2,opt,name=day_of_week,json=dayOfWeek,proto3,enum=example.enums.DayOfWeek" json:"day_of_week,omitempty"`
}

func (x *EnumsMessage) Reset() {
	*x = EnumsMessage{}
...
func (x *EnumsMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnumsMessage) ProtoMessage() {}

func (x *EnumsMessage) ProtoReflect() protoreflect.Message {
	mi := &file_enums_enums_proto_msgTypes[0]
...
// Deprecated: Use EnumsMessage.ProtoReflect.Descriptor instead.
func (*EnumsMessage) Descriptor() ([]byte, []int) {
	return file_enums_enums_proto_rawDescGZIP(), []int{0}
}

func (x *EnumsMessage) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *EnumsMessage) GetDayOfWeek() DayOfWeek {
	if x != nil {
		return x.DayOfWeek
	}
	return DayOfWeek_UNKWNOWN
}
...
var file_enums_enums_proto_rawDesc = []byte{
	...
	,
	...
	0x59, 0x10, 0x07, 0x42, 0x0f, 0x5a, 0x0d, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x3b, 0x65, 0x6e, 0x75,
...
var file_enums_enums_proto_goTypes = []interface{}{
	(DayOfWeek)(0),       // 0: example.enums.DayOfWeek
	(*EnumsMessage)(nil), // 1: example.enums.EnumsMessage
}
var file_enums_enums_proto_depIdxs = []int32{
	0, // 0: example.enums.EnumsMessage.day_of_week:type_name -> example.enums.DayOfWeek
